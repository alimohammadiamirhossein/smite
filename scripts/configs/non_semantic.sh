...
train_dirs["non_semantic"]="data/complex/train_5"
val_dirs["non_semantic"]="data/complex/val"
test_dirs["non_semantic"]="data/complex/val"
...
checkpoint_paths["non_semantic"]="logs/log1_5_10/log_non_semantic_train_5/ckpt_best.pt"

video_base_paths["non_semantic"]="data/half_face/vi"
...
gt_base_paths["non_semantic"]="ground_truth/non_semantic"
