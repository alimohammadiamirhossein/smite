...
train_dirs["car"]="data/training_data/car"
val_dirs["car"]="data/car/val"
test_dirs["car"]="data/car/test"
...
checkpoint_paths["car"]="logs/log_car_2024-11-14_21-50-57/ckpt_best.pt"

video_base_paths["car"]="data/car/vi/"
...
gt_base_paths["car"]="ground_truth/car"
