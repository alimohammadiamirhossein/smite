...
# train_dirs["davis"]="/localhome/aaa324/Project/Davis2016/train_data"
train_dirs["davis"]="/localhome/aaa324/Project/Davis2016/single_instance/soapbox"
val_dirs["davis"]="/localhome/aaa324/Project/Davis2016/single_instance/soapbox"
test_dirs["davis"]="/localhome/aaa324/Project/Davis2016/test_data"
...
checkpoint_paths["davis"]="/localhome/aaa324/Project/FLATTEN/SMiTe/SMITE/logs/log_davis_soapbox/ckpt_best.pt"

video_base_paths["davis"]="/localhome/aaa324/Project/Davis2016/DAVIS_test"
...
gt_base_paths["davis"]="/localhome/aaa324/Project/Davis2016/DAVIS_test/ground_truth"
